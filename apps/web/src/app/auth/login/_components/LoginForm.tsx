  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        if (result.success) {
          router.push(searchParams.get("next") ?? "/dashboard/profile");
        } else {
          ...
          <form onSubmit={handleSubmit} noValidate>
            <fieldset className="space-y-6">
              ...
              <div className="text-center">
                ...
                <h1 className="mt-3 text-xl font-semibold text-text-primary">ยินดีต้อนรับกลับ</h1>
                <p className="mt-1 text-sm text-text-secondary">เข้าสู่ระบบบัญชีผู้หางาน</p>
              </div>
