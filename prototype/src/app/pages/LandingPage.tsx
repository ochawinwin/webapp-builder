...
import { Briefcase, Zap, BarChart3, Users, CheckCircle, ArrowRight, Search, Target, ShieldCheck } from "lucide-react";
  ...
  const features = [
    {
      ...
      title: "Smart Match",
      description: "ระบบจับคู่ทักษะของคุณกับตำแหน่งงานที่ใช่ที่สุดด้วย AI Tags",
    },
    {
      icon: <Zap className="w-6 h-6 text-secondary" />,
      title: "Easy Apply",
      description: "สมัครงานง่ายเพียงคลิกเดียว พร้อมจัดการ Resume แบบครบวงจร",
    },
    {
      icon: <BarChart3 className="w-6 h-6 text-accent" />,
      title: "Kanban ATS",
      description: "ระบบจัดการผู้สมัครแบบ Kanban Board สำหรับบริษัท ติดตามง่ายทุกขั้นตอน",
    },
    {
      icon: <ShieldCheck className="w-6 h-6 text-success" />,
      title: "Verification",
      description: "ยืนยันตัวตนทั้งฝั่งผู้หางานและบริษัท เพื่อความปลอดภัยและเชื่อมั่น",
    },
  ];
    ...
    <div className="flex flex-col w-full overflow-hidden">
      ...
      <section className="relative pt-20 pb-24 lg:pt-32 lg:pb-40 bg-gradient-to-br from-white to-primary/5">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <Badge variant="secondary" className="w-fit text-sm py-1.5 px-4 font-poppins">
            ...
            <h1 className="text-5xl lg:text-7xl font-bold font-kanit text-foreground tracking-tight leading-[1.1]">
              หางานที่ใช่ <span className="text-primary italic">ในแบบที่คุณเป็น</span> ด้วย Smart Matching
            </h1>
            <p className="text-xl text-muted-foreground font-sarabun leading-relaxed">
              ...
              ลดความซับซ้อนในการสมัครงาน และเพิ่มความแม่นยำในการหาบุคลากรที่ตรงใจ
            </p>
            <div className="flex flex-wrap gap-4 pt-4">
              <Link to="/search">
                <Button size="lg" className="px-8 h-14 text-lg font-kanit">
                  เริ่มหางานทันที <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
              <Link to="/hr/login">
                <Button variant="outline" size="lg" className="px-8 h-14 text-lg font-kanit">
                  สำหรับบริษัท / HR
                </Button>
              </Link>
            </div>
            ...
            <div className="flex items-center gap-6 pt-6 grayscale opacity-60">
              <div className="text-sm font-semibold uppercase tracking-widest text-muted-foreground font-poppins">Trusted By:</div>
          ...
          >
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl border-8 border-white transform hover:scale-[1.02] transition-transform duration-500">
              <ImageWithFallback 
                ...
                alt="Happy coworkers high-fiving"
            ...
            <motion.div 
              ...
              className="absolute top-20 -right-8 bg-white p-4 rounded-xl shadow-xl border border-border flex items-center gap-3"
            >
              <div className="w-10 h-10 bg-success/20 rounded-full flex items-center justify-center text-success">
                <CheckCircle className="w-6 h-6" />
              </div>
              <div>
                <p className="text-xs text-muted-foreground font-semibold uppercase">Matches Found</p>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-4xl font-bold font-kanit mb-6 leading-tight">ทำไมต้อง FutureCareer?</h2>
          ...
          >
            {features.map((feature, idx) => (
              <motion.div key={idx} variants={item}>
                <Card className="p-8 h-full flex flex-col items-center text-center gap-6 border-none shadow-none bg-muted/50 hover:bg-white hover:shadow-xl hover:scale-[1.05] transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-primary rounded-[2.5rem] p-12 lg:p-24 relative overflow-hidden flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex flex-col gap-6 max-w-xl text-white relative z-10 text-center lg:text-left">
              <h2 className="text-4xl lg:text-5xl font-bold font-kanit leading-tight">พร้อมเริ่มต้นก้าวแรก <br />สู่ความสำเร็จแล้วหรือยัง?</h2>
              ...
              <div className="flex flex-wrap gap-4 pt-4 justify-center lg:justify-start">
                ...
                <Link to="/search">
                  <Button size="lg" className="px-8 h-14 text-lg bg-white text-primary hover:bg-white/90">
                    ดูงานที่เปิดรับ
                  </Button>
                </Link>
              </div>
            ...
            <div className="lg:flex-1 grid grid-cols-2 gap-4 relative z-10 w-full lg:w-auto">
              <div className="flex flex-col gap-4 mt-8">
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  ...
                  <p className="text-primary-foreground/70 text-sm">บริษัทชั้นนำ</p>
                </div>
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <p className="text-3xl font-bold text-white">2,000+</p>
                  <p className="text-primary-foreground/70 text-sm">ตำแหน่งงานใหม่/เดือน</p>
                </div>
              </div>
              <div className="flex flex-col gap-4">
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <p className="text-3xl font-bold text-white">95%</p>
                  <p className="text-primary-foreground/70 text-sm">ความพึงพอใจ</p>
                </div>
                <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                  <p className="text-3xl font-bold text-white">10min</p>
                  <p className="text-primary-foreground/70 text-sm">เวลาเฉลี่ยในการสมัคร</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Testimonials or Brands */}
      <section className="py-24 border-t border-border bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold font-kanit mb-16">บริษัทที่มองหาบุคลากรกับเรา</h2>
